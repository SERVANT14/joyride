...
;(function ($, window, undefined) {
  ...
  var defaults = {
      ...
      'template' : { // HTML segments for tip layout
        ...
        'directTip'  : '<a href="#" class="joyride-direct-tip"></a>',
    ...
    methods = {
      ...
      button_direct : function (txt) {
        if (settings.directTip) {
          txt = $.trim(txt) || 'Choose direct Tip';
          txt = methods.outerHTML($(settings.template.directTip).append(txt)[0]);
        } else {
          txt = '';
        }
        return txt;
